...
def imageDetection():
    ...
    cv2.putText(img, 'Image Data Detected as : '+labels[predict], (10, 25),  cv2.FONT_HERSHEY_SIMPLEX,0.7, (255, 0, 0), 2)
    cv2.imshow('Image Data Detected as : '+labels[predict], img)
    cv2.waitKey(0)
...
def voiceDetection():
    ...
    messagebox.showinfo("Uploaded Voice Data Detected as "+labels[predict],"Uploaded Voice Data Detected as "+labels[predict])
